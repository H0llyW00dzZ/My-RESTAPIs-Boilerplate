var htmx = (function () {
    ...
    function Hn(e, t, n) {
        ...
        if (n) {
            if (n instanceof Element || typeof n === "string") {
                ...
                return he(e, t, y(n.source), n.event, { handler: n.handler, headers: n.headers, values: n.values, targetOverride: y(n.target), swapOverride: n.swap, select: n.select, returnPromise: true });
            }
        } else {
    ...
    function he(t, n, r, o, i, D) {
        ...
        const H = { xhr: p, target: u, requestConfig: C, etc: i, boosted: _, select: X, pathInfo: { requestPath: n, finalRequestPath: R, responsePath: null, anchor: O } };
        p.onload = function () {
            try {
                const t = Tn(r);
    ...
    function Mn(o, i) {
        ...
        if (f) {
            fe(o, "htmx:responseError", ue({ error: "Response Status Error Code " + s.status + " from " + i.pathInfo.requestPath }, i));
        }
    }
    const Xn = {};
    function Fn() {
