...
//
//   - The key exchange mechanism is not supported (and won't be implemented even though implementing key exchange is easy) because it is not used for external services such as TLS or other external services.
