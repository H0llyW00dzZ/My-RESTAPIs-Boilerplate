...
// on a powerful Redis instance (higher specifications) can lead to POOL EXHAUSTION (e.g, Small Pool: You have a powerful Redis server, but the connection pool size (maxConnections) is small),
